  ...
  return new Promise(function (resolve, reject) {
    ...
    exports.checkConnection(url, username, password)
      ...
      .then(function (response) {
        ...
        var data = {
          "url": url, "username": username, "password": db.encryptString(password), "cron_update": limited, "cron_update_expanded": expanded,
...
function translateAPIDeviceToDatabaseObject(device, serverId, type) {
  ...
  var dbObject = {
    "server_id": serverId, "device_type": type, "jss_id": device.id, "jss_name": cleanInput(device.name),
